...
　　　　　　地域：東京都中心（47％）→次点で神奈川
　　　　　　聴取時間傾向：平日：8時~9時台、22時台
　　　　　　　　　　　　　土日：7時~9時台、夜の23時にピーク", "img": "cluster_1.png"},
        2: {"text": "クラスタ2：ビジネスマン中心。通勤時間帯に情報収集。", "img": "cluster_2.png"},
        3: {"text": "クラスタ3：主婦層。午前中にトーク番組を聴く傾向。", "img": "cluster_3.png"},
        4: {"text": "クラスタ4：学生＋シニア混合。深夜帯のニッチな番組志向。", "img": "cluster_4.png"},
        5: {"text": "クラスタ5：若年社会人。夜のリラックスタイムにBGM志向。", "img": "cluster_5.png"},
        6: {"text": "クラスタ6：働く中高年。通勤・夜にニュースや情報番組を好む。", "img": "cluster_6.png"},
        7: {"text": "クラスタ7：週末型リスナー。週末朝のルーティン聴取。", "img": "cluster_7.png"},
    }
